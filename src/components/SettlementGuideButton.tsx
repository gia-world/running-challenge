...
const SETTLEMENT_GUIDE: GuideItem[] = [
  ...
  },
  {
    emoji: "🏆",
    title: "상금",
    body: "완주하지 못한 사람들이 다 돌려받지 못한 참가비를 모아 완주한 사람들에게 똑같이 나눠요. 챌린지 참여자가 모두 성공하거나 모두 실패하면 상금이 없어요.",
  },
  {
    emoji: "💸",
    title: "벌금",
    body: "목표를 채우지 못하면 참가비 중 못 돌려받는 금액이 생겨요. 연장을 신청해도 이 금액은 이월되지 않고, 계좌로 따로 입금해야 해요.",
  },
  {
    emoji: "🔁",
    title: "다음 시즌 연장",
    body: "연장을 신청하면 환급액이 현금 대신 다음 시즌 참가비로 이월돼요.",
  },
  {
    emoji: "🚪",
    title: "중도하차",

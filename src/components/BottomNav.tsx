...
/** The 4 screens a crew member taps into daily — everything else (관리자,
 * 마이페이지, 시즌 전체 기록, 로그아웃) lives in the header's hamburger menu
 * instead, since those are occasional destinations, not daily habits. */
